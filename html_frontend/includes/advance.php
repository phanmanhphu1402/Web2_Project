...
<div class="btn-searching-advance">
	...
	<?php
		if(isset($_SESSION['role'])&&$_SESSION['role']!=3){
			...
			<button class="btn-admin-advance-floating"><a href="../../admin\templates\admin.php" style="text-decoration: none;color: white;font-size:16px;font-family: Arial, Helvetica, sans-serif;">Go back admin</a></button>
		</div>';
		}
	?>
