...
INSERT INTO `bill` (`OrderID`, `Fullname`, `Phone`, `Email`, `Address`, `Order_date`, `TotalPrice`, `Username`, `status`) VALUES
(1, 'Phan Mạnh Phú', '349867919', 'phu@gmail.com', 'Ho Chi Minh', '2024-05-07 04:42:02', 1251, 'phu', 2),
(111, 'anh k', '349867919', 'phu@gmail.com', 'Ho Chi Minh', '2024-05-17 04:42:02', 1251, 'phu', 1);
...
INSERT INTO `bill_detail` (`OrderID`, `ProductID`, `ProductName`, `ProductPrice`, `ProductNum`) VALUES
(1, 8, 'Samsung Galaxy S22 Plus trắng', 1250, 1);
...
(61, 'Vivo Y35 Đen', 1000, 'vivo-y35-thumb-den-600x600.jpg', 4, 'Vivo', 'Chip Unisoc SC9863A1  RAM: 4 GB  Dung lượng: 256 GB  Camera sau: 8 MP  Camera trước: 5 MP  Pin 5000 mAh, Sạc 10 W', 0),
...
('phu', '123123', 'Phan Mạnh Phú', 'phu@gmail.com', 'Ho Chi Minh', 349867919, '2024-05-09', 1, 'Đang hoạt động', 12);
...
--
ALTER TABLE `product`
  MODIFY `ProductID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
...
--
ALTER TABLE `bill_detail`
  ADD CONSTRAINT `bill_detail_ibfk_1` FOREIGN KEY (`OrderID`) REFERENCES `bill` (`OrderID`) ON DELETE CASCADE ON UPDATE CASCADE,
